...
from src.config import PROD_URI, REDIS_HOST, REDIS_PORT, PRODUCTION, REDIS_USER, REDIS_PASSWORD

if REDIS_USER or REDIS_PASSWORD:
    redis_server = f'redis://{REDIS_USER}:{REDIS_PASSWORD}@{REDIS_HOST}:{REDIS_PORT}'
else:
