...
create_system_descr = ("""Создание нового поставщика услуг.""")

edit_system_descr = ("""Редактирование поставщика услуг.""")

get_systems_descr = ("""Получение списка поставщиков услуг.""")

delete_system_descr = ("""Удаление поставщика услуг.""")
