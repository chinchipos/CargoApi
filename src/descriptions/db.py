...
db_init_description = (
    ...
    **Инициализация БД.**<br>
    <br>
    1. Очистка таблиц.<br>
    2. Создание типов карт.<br>
    3. Создание ролей.<br>
    4. Создание первого суперадмина.
    """
)

db_initial_sync_description = (
    """
    Коннектор для первичной синхронизации локальной БД с мигрируемой. Прогружаются следующие данные.<br>
    <br>
    1. Системы.<br>
    2. Тарифы.<br>
    3. Организации.<br>
    ...
    **Входные параметры (передаются в теле запроса):**<br>
    <br>
    **service_token** - сервисный токен (прописан в конфигурационном файле **.env**).<br>
    <br>
...
db_regular_sync_description = (
    """
    Коннектор для регулярной синхронизации локальной БД с мигрируемой. Прогружаются следующие данные:<br>
    <br>
    1. Организации.<br>
    <br>
    **Входные параметры (передаются в теле запроса):**<br>
